...
class talkNetModel(nn.Module):
    ...
    def forward(self, input):
        inputA, inputV = input
        embedA = self.forward_audio_frontend(inputA)
        embedV = self.forward_visual_frontend(inputV)
        embedA, embedV = self.forward_cross_attention(embedA, embedV)
        out = self.forward_audio_visual_backend(embedA, embedV)
